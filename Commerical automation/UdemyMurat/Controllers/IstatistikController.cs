...
namespace UdemyMurat.Controllers
{
    public class IstatistikController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.d9 = deger9;
            var deger10 = c.Uruns.Count(x => x.UrunAd=="Buz Dolabi").ToString();
            ViewBag.d10= deger10;
            ...
            var deger13 =c.Uruns.Where(u=>u.UrunId==(c.SatisHarekets.GroupBy(x=>x.UrunId).
                OrderByDescending(z=>z.Count()).Select(e=>e.Key).FirstOrDefault())).Select(k=>k.UrunAd).FirstOrDefault();
            ViewBag.d13 = deger13;
            ...
            //decimal? null olanda xeasin qaytarmir//
            ViewBag.d16 = deger16;
            return View();
        }
        public ActionResult SadeCedvel()
        {
            var sorğu = from x in c.Carilers.Where(x => x.Durum == true)
        ...
        {
            var sorgu2 = from x in c.Personels.Where(x => x.Durum == true)
        ...
        {
            var sorgu = from x in c.Uruns.Where(x=> x.Durum == true)
